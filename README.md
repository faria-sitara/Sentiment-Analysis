...
This project applies Natural Language Processing (NLP) and multiple sentiment analysis techniques to analyze and compare customer reviews from Amazon. The goal is to classify text into positive, neutral, or negative sentiment, visualize trends, and compare different sentiment models such as VADER, TextBlob, and RoBERTa.
